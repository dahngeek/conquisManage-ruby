...
class CounselorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counselor" do
    assert_difference('Counselor.count') do
      post counselors_url, params: { counselor: { dni: @counselor.dni, last_name: @counselor.last_name, name: @counselor.name } }
    end
  ...
  test "should update counselor" do
    patch counselor_url(@counselor), params: { counselor: { dni: @counselor.dni, last_name: @counselor.last_name, name: @counselor.name } }
